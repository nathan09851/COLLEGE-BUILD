...
export default async function FacultyPage({ searchParams }: PageProps) {
  ...
  if (search) {
    query = query.or(`first_name.ilike.%${search}%,last_name.ilike.%${search}%,specialization.ilike.%${search}%,designation.ilike.%${search}%`)
  }
        ...
        <div className="container-custom relative">
          <div className="max-w-3xl">
            ...
            <h1 className="headline-xl mb-8 leading-[1.1] text-slate-900">
              Distinguished <br />
              <span className="text-secondary">Academic Leadership.</span>
            </h1>
